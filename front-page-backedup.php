...
<!--check if the post has a Post Thumbnail assigned to it, and if so, displays it and links to the "large" Post Thumbnail image size and must be used within The Loop. -->
						 <?php 
                        ...
                        <div class="announce-title">
                   		...
                   		</div><!--end announce-title-->
					</div><!--end announce-top-->
